...
for i in {1..5}; do
    # 使用香港 url
    docker exec -i docker$i bash -c "titan-edge bind --hash=A9E75326-CA85-4C3E-9FE5-2B50867EE5F4 https://api-test1.container1.titannet.io/api/v2/device/binding --url=https://hk-locator.titannet.io:5000/rpc/v0"
done
